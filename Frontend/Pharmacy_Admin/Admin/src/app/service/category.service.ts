...
export class CategoryService {
  ...
  async findAll(): Promise<any> {
    return await lastValueFrom(
      this.httpClient.get(
        this.baseUrl.getBaseUrl() + 'api/v1/categories/findAll'
      )
    );
  }
  async findAllCategory(): Promise<any> {
    return await lastValueFrom(
      this.httpClient.get(
        this.baseUrl.getBaseUrl() + 'api/v1/categories/findParentCategories'
      )
    );
  }
    ...
    return await lastValueFrom(
      this.httpClient.get(
        this.baseUrl.getBaseUrl() +
          'api/v1/categories/findByIdParentCategories/' +
          id
      )
    );
  }
  ...
  async findByCategoryId(id: number): Promise<any> {
    return await lastValueFrom(
      this.httpClient.get(
        this.baseUrl.getBaseUrl() + 'api/v1/categories/findByCategoryId/' + id
      )
    );
  }
}
