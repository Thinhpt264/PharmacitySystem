...
async createPromotion(promo: PromotionRequestDTO): Promise<PromotionResponseDTO> {
  return await lastValueFrom(
...
async updatePromotion(id: number, promo: PromotionRequestDTO): Promise<PromotionResponseDTO> {
  return await lastValueFrom(
